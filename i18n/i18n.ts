...
`,
        ...
        loading: 'Loading',
        please_wait_iap: 'Connecting to the store, please wait...',
        iap_unavailable: 'Could not connect to the App Store. Please try again.',
        purchase_failed: 'Purchase failed. Please try again.',
        dev_mode_title: 'Dev Mode',
        dev_simulate_purchase: 'App Store products are not set up yet. Simulate snooze payment?',
        iap_products_unavailable: 'In-app purchases are not available. Check App Store Connect and try again.',
        no_payment_tier: 'This alarm has no payment tier associated.',
        pay_now: 'Pay Now',
        ...
        onboarding_title_4: 'Don\'t Miss Out',
        onboarding_desc_4: 'We need notification permissions to play the alarm sound even when the app is closed.',
        onboarding_title_custom_sound: 'Wake Up Your Way',
        onboarding_desc_custom_sound: 'Upload your own favorite track or choose from our sounds.',
        onboarding_start: 'Get Started',
        next: 'Next',
        continue: 'Continue',
        default_sound: 'Classic',
        add_custom_sound: 'Add Custom Sound',
        delete_sound: 'Delete Sound',
        delete_sound_confirm: 'Are you sure you want to delete this sound?',
    },
    tr: {
        welcome: 'Günaydın',
        snooze: 'Ertele',
...
`,
        ...
        loading: 'Yükleniyor',
        please_wait_iap: 'Mağaza bağlanıyor, lütfen bekleyin...',
        iap_unavailable: 'App Store\'a bağlanılamadı. Lütfen tekrar deneyin.',
        purchase_failed: 'Satın alma başarısız. Lütfen tekrar deneyin.',
        dev_mode_title: 'Geliştirici Modu',
        dev_simulate_purchase: 'App Store ürünleri henüz yapılandırılmadı. Erteleme ödemesi simüle edilsin mi?',
        iap_products_unavailable: 'Uygulama içi satın alma kullanılamıyor. App Store Connect ayarlarını kontrol edin.',
        no_payment_tier: 'Bu alarmda ödeme seviyesi tanımlı değil.',
        pay_now: 'Şimdi Öde',
        ...
        welcome_onboard: 'Aramıza Hoş Geldin!',
        account_created_success: 'Hesabın başarıyla oluşturuldu.',
        ...
        onboarding_title_4: 'Bildirim İzni',
        onboarding_desc_4: 'Alarmın çalabilmesi için bildirim izni vermeniz gerekiyor. Aksi takdirde ses çalamayız.',
        onboarding_title_custom_sound: 'İstediğin Gibi Uyan',
        onboarding_desc_custom_sound: 'Kendi favori parçanı yükle veya seslerimizden birini seç.',
        onboarding_start: 'Hemen Başla',
        next: 'İleri',
        continue: 'Devam Et',
        default_sound: 'Klasik',
        add_custom_sound: 'Özel Ses Ekle',
        delete_sound: 'Sesi Sil',
        delete_sound_confirm: 'Bu sesi silmek istediğinizden emin misiniz?',
    },
    de: {
...
`,
        ...
        loading: 'Laden',
        please_wait_iap: 'Verbindung zum Store, bitte warten...',
        iap_unavailable: 'Verbindung zum App Store fehlgeschlagen. Bitte erneut versuchen.',
        purchase_failed: 'Kauf fehlgeschlagen. Bitte erneut versuchen.',
        dev_mode_title: 'Entwicklermodus',
        dev_simulate_purchase: 'App Store-Produkte noch nicht eingerichtet. Schlummerzahlung simulieren?',
        iap_products_unavailable: 'In-App-Käufe nicht verfügbar. App Store Connect prüfen.',
        no_payment_tier: 'Dieser Alarm hat keine Zahlungsstufe.',
...
`,
        ...
        loading: 'Chargement',
        please_wait_iap: 'Connexion au store, veuillez patienter...',
        iap_unavailable: 'Impossible de se connecter à l\'App Store. Veuillez réessayer.',
        purchase_failed: 'Achat échoué. Veuillez réessayer.',
        dev_mode_title: 'Mode Dev',
        dev_simulate_purchase: 'Produits App Store non configurés. Simuler le paiement?',
        iap_products_unavailable: 'Achats intégrés indisponibles. Vérifiez App Store Connect.',
        no_payment_tier: 'Cette alarme n\'a pas de niveau de paiement.',
...
`,
        ...
        loading: 'Cargando',
        please_wait_iap: 'Conectando a la tienda, por favor espera...',
        iap_unavailable: 'No se pudo conectar a la App Store. Inténtalo de nuevo.',
        purchase_failed: 'Compra fallida. Inténtalo de nuevo.',
        dev_mode_title: 'Modo Dev',
        dev_simulate_purchase: 'Productos de App Store no configurados. ¿Simular pago?',
        iap_products_unavailable: 'Compras integradas no disponibles. Revisa App Store Connect.',
        no_payment_tier: 'Esta alarma no tiene nivel de pago.',
        pay_now: 'Pagar ahora',
    ...
    it: {
        ...
        loading: 'Caricamento',
        please_wait_iap: 'Connessione allo store, attendere...',
        iap_unavailable: 'Impossibile connettersi all\'App Store. Riprova.',
        purchase_failed: 'Acquisto fallito. Riprova.',
        dev_mode_title: 'Modalità Dev',
        dev_simulate_purchase: 'Prodotti App Store non configurati. Simulare il pagamento?',
        iap_products_unavailable: 'Acquisti in-app non disponibili. Controlla App Store Connect.',
        no_payment_tier: 'Questa sveglia non ha un livello di pagamento.',
        pay_now: 'Paga Ora',
    ...
    pt: {
        ...
        loading: 'Carregando',
        please_wait_iap: 'Conectando à loja, aguarde...',
        iap_unavailable: 'Não foi possível conectar à App Store. Tente novamente.',
        purchase_failed: 'Compra falhou. Tente novamente.',
        dev_mode_title: 'Modo Dev',
        dev_simulate_purchase: 'Produtos da App Store não configurados. Simular pagamento?',
        iap_products_unavailable: 'Compras no app indisponíveis. Verifique o App Store Connect.',
        no_payment_tier: 'Este alarme não tem nível de pagamento.',
        pay_now: 'Pagar Agora',
    ...
    ru: {
        ...
        loading: 'Загрузка',
        please_wait_iap: 'Подключение к магазину, подождите...',
        iap_unavailable: 'Не удалось подключиться к App Store. Попробуйте снова.',
        purchase_failed: 'Покупка не удалась. Попробуйте снова.',
        dev_mode_title: 'Режим разработки',
        dev_simulate_purchase: 'Продукты App Store не настроены. Симулировать оплату?',
        iap_products_unavailable: 'In-app покупки недоступны. Проверьте App Store Connect.',
        no_payment_tier: 'У этого будильника нет уровня оплаты.',
        pay_now: 'Оплатить',
    ...
    ja: {
        ...
        processing: '処理中...',
        loading: '読み込み中',
        please_wait_iap: 'ストアに接続中です。お待ちください...',
        iap_unavailable: 'App Storeに接続できませんでした。もう一度お試しください。',
        purchase_failed: '購入に失敗しました。もう一度お試しください。',
        dev_mode_title: '開発モード',
        dev_simulate_purchase: 'App Store商品が未設定です。支払いをシミュレートしますか？',
        iap_products_unavailable: 'アプリ内課金が利用できません。App Store Connectを確認してください。',
        no_payment_tier: 'このアラームに支払いティアがありません。',
        pay_now: '支払う',
    ...
    zh: {
        ...
        processing: '处理中...',
        loading: '加载中',
        please_wait_iap: '正在连接商店，请稍候...',
        iap_unavailable: '无法连接到 App Store，请重试。',
        purchase_failed: '购买失败，请重试。',
        dev_mode_title: '开发模式',
        dev_simulate_purchase: 'App Store 产品尚未配置。是否模拟支付？',
        iap_products_unavailable: '应用内购买不可用。请检查 App Store Connect。',
        no_payment_tier: '此闹钟未关联支付等级。',
        pay_now: '立即支付',
